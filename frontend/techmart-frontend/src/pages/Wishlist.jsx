...
const styles = {
  ...
  name: { color: "var(--text-primary)", fontSize: "15px", fontWeight: "600", marginBottom: "8px" },
  ...
  if (wishlist.length === 0) {
    return (
      <div style={styles.emptyWrap}>
        ...
        <h2 style={{ color: "var(--text-primary)", marginTop: "16px" }}>Your wishlist is empty</h2>
        <p style={{ color: "var(--text-muted)", marginBottom: "24px" }}>Save products you love for later!</p>
