      ...
      <div style={isMobile ? styles.layoutMobile : styles.layout}>
        {isMobile && (
          <div style={styles.summaryMobile}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
              <span style={{ color: "var(--text-muted)", fontSize: "14px" }}>Total ({cart.length} item{cart.length !== 1 ? "s" : ""})</span>
          ...
          {cart.map((item) => (
            <div key={item._id} style={styles.card}>
              ...
              <div style={styles.details}>
                ...
                <p style={{ color: "var(--text-muted)", fontSize: "13px" }}>₦{item.price?.toLocaleString()} each</p>
        ...
        {!isMobile && (
          <div style={styles.summary}>
            ...
            <div style={styles.summaryRow}>
              <span style={{ color: "var(--text-primary)", fontWeight: "700", fontSize: "18px" }}>Total</span>
              <span style={{ color: "#f97316", fontWeight: "800", fontSize: "20px" }}>₦{total.toLocaleString()}</span>
            </div>
            ...
            <Link to="/" style={{ display: "block", marginTop: "12px", textAlign: "center" }}>
              <span style={{ color: "var(--text-muted)", fontSize: "13px" }}>or continue shopping</span>
            </Link>
          </div>
        )}
      </div>
